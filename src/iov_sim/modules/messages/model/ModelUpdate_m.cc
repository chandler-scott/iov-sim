...
ModelUpdate::ModelUpdate(const char *name, short kind) : ::iov_sim::ModelBaseMessage(name, kind)
{
}

ModelUpdate::ModelUpdate(const ModelUpdate& other) : ::iov_sim::ModelBaseMessage(other)
{
    copy(other);
}
...
ModelUpdateDescriptor::ModelUpdateDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(iov_sim::ModelUpdate)), "iov_sim::ModelBaseMessage")
{
