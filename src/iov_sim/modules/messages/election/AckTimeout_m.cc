//
// Generated file, do not edit! Created by opp_msgtool 6.0 from iov_sim/modules/messages/election/AckTimeout.msg.
//
...
AckTimeout::AckTimeout(const char *name, short kind) : ::iov_sim::ElectionBaseMessage(name, kind)
{
}

AckTimeout::AckTimeout(const AckTimeout& other) : ::iov_sim::ElectionBaseMessage(other)
{
    copy(other);
}
...
AckTimeoutDescriptor::AckTimeoutDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(iov_sim::AckTimeout)), "iov_sim::ElectionBaseMessage")
{
