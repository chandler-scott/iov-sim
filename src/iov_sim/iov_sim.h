...
#define IOV_SIM_VERSION_MAJOR 0
#define IOV_SIM_VERSION_MINOR 1
#define IOV_SIM_VERSION_PATCH 0
#define IOV_SIM_VERSION_ALPHA 0
...
// IOV_SIM_API macro. Allows us to use the same .h files for both building a .dll and linking against it
