...
BaseMessage::BaseMessage(const char *name, short kind) : ::veins::BaseFrame1609_4(name, kind)
{
}

BaseMessage::BaseMessage(const BaseMessage& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
const ::veins::LAddress::L2Type& BaseMessage::getSenderAddress() const
{
    return this->senderAddress;
}

void BaseMessage::setSenderAddress(const ::veins::LAddress::L2Type& senderAddress)
{
    this->senderAddress = senderAddress;
}

int BaseMessage::getSerial() const
{
    return this->serial;
}

void BaseMessage::setSerial(int serial)
{
    this->serial = serial;
}
...
BaseMessageDescriptor::BaseMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(iov_sim::BaseMessage)), "veins::BaseFrame1609_4")
{
