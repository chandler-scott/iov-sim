...
#ifndef __IOV_SIM_TIMER_M_H
#define __IOV_SIM_TIMER_M_H
...
/**
 * Class generated from <tt>iov_sim/base/messages/Timer.msg:27</tt> by opp_msgtool.
 * <pre>
 * packet Timer extends BaseMessage
 * {
 *     double time;
 * }
 * </pre>
 */
class IOV_SIM_API Timer : public ::iov_sim::BaseMessage
{
  protected:
    double time = 0;
...
template<> inline iov_sim::Timer *fromAnyPtr(any_ptr ptr) { return check_and_cast<iov_sim::Timer*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __IOV_SIM_TIMER_M_H
