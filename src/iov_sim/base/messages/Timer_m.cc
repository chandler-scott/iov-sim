//
// Generated file, do not edit! Created by opp_msgtool 6.0 from iov_sim/base/messages/Timer.msg.
//
...
Timer::Timer(const char *name, short kind) : ::iov_sim::BaseMessage(name, kind)
{
}

Timer::Timer(const Timer& other) : ::iov_sim::BaseMessage(other)
{
    copy(other);
}
...
TimerDescriptor::TimerDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(iov_sim::Timer)), "iov_sim::BaseMessage")
{
